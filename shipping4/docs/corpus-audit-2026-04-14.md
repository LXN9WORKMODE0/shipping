...
- 运行时间: 2026-04-14T23:55:28+08:00
- run_id: `20260414-235528`
- 机器结果: `workspace\_audit\20260414-235528\results.json`
...
- 总成功率: 0.667
- 阶段失败率统计: none: 3
- 平均耗时: convert_seconds: 38.727；parse_seconds: 75.819；summarize_seconds: 375.831；summary_independence_seconds: 316.942；total_seconds: 828.184

## 问题清单

### P1
- 低置信节点占比异常 (1): 大批节点仍处于低置信状态，结构质量不足以直接支撑综述。
...
- 正文节点缺失 (1): 解析结果只有前置页或特殊节点，正文结构不可用。
...
## 下一步建议
- 优先修 phase2 的前置页识别、目录识别和标题编号规则，再扩大样本。
